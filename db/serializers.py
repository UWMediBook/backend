...
class mainSerializer(serializers.ModelSerializer):
	...
	class Meta:
	   model = main
	   fields = ('USER_ID', 'PRIMARY_ID', 'ALLERGY_ID', 'SURGERY_ID', 'VISIT_ID', 'PRESCRIPTION_ID', 'EC_ID', 'F_NAME', 'L_NAME', 'ADDRESS', 'GENDERS', 'GENDER', 'BIRTHDAY', 'EMAIL', 'PASSWORD', 'HEALTHCARD_NUM', 'CREATED', 'UPDATED')
